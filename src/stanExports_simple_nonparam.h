...
namespace model_simple_nonparam_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_simple_nonparam");
    reader.add_event(58, 56, "end", "model_simple_nonparam");
    return reader;
}
#include <stan_meta_header.hpp>
class model_simple_nonparam
  : public stan::model::model_base_crtp<model_simple_nonparam> {
private:
        int N;
        int n_x;
        int n_r;
        ...
        double n_prior_obs;
public:
    model_simple_nonparam(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_simple_nonparam_namespace::model_simple_nonparam";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("alpha", "n_x", n_x);
        context__.validate_dims("parameter initialization", "alpha", "vector_d", context__.to_vec(n_x));
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha(n_x);
        size_t alpha_j_1_max__ = n_x;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                alpha = in__.vector_lb_constrain(0, n_x, lp__);
            else
                alpha = in__.vector_lb_constrain(0, n_x);
            current_statement_begin__ = 24;
            ...
            lp_accum__.add(gamma_log<propto__>(alpha, 1.5, (1.5 / n_prior_obs)));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_simple_nonparam_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha = in__.vector_lb_constrain(0, n_x);
        size_t alpha_j_1_max__ = n_x;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
...
typedef model_simple_nonparam_namespace::model_simple_nonparam stan_model;
#ifndef USING_R
