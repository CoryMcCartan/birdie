...
#include "stanExports_simple_nonparam.h"

RCPP_MODULE(stan_fit4simple_nonparam_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_simple_nonparam")
