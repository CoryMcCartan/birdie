...
#include "stanExports_simple_additive.h"

RCPP_MODULE(stan_fit4simple_additive_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_simple_additive")
