...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(55, 53, "end", "model_multinom");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "w", "row_vector_d", context__.to_vec(N));
            w = Eigen::Matrix<double, 1, Eigen::Dynamic>(N);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(sum(multiply(w, elt_multiply(Y, lsft))));
