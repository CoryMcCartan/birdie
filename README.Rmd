...
in [Imai, Olivella, and Rosenman (2022)](https://arxiv.org/abs/2205.06129/).
...
To computing BISG probabilities, you [provide the last name and (optionally) geography variables as part of a formula.
...
Additional functions allow us to extract a tidy version of our estimates.
