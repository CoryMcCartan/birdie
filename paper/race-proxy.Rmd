...
However, as we have discussed, high accuracy alone is neither necessary nor sufficient for accurate estimation of racial disparities.
...
Accurate but biased racial probabilities will lead to bias in downstream estimates, regardless of which disparity estimator is used.
...
As researchers have increasingly applied racial prediction and imputation methods to administrative datasets, including many public datasets, there has been growing concern about ethical and privacy considerations around performing such predictions.
While some scholars do not view racial prediction methods as privacy risks [@buncomment, "Statistical Inference is Not a Privacy Violation"], we believe it is important for researchers to consider the implications of their use of racial prediction methods.
...
Among other findings, their data established that asking for consent in data collection is strongly associated with the study being viewed as more ethically permissible.
They also found that studies which focused on accurate estimation of racial disparities were viewed as more ethically permissible than studies that overestimated or underestimated the size of disparities.
...
In fact, as our validation study demonstrated, different sets of individual race predictions of varying individual accuracies (county-based versus block-based BISG) produced very similar estimates of racial disparities.
To the extent that BIRDiE allows researchers to focus less on maximizing individual predictive accuracy, the method could alleviate some privacy concerns and reduce incentives to collect and link more personal data in an attempt to further increase accuracy.
We view this as a welcome change, consistent with the public's preference for focusing on accurate disparity information.

However, BIRDiE does allow for the creation of improved BISG probabilities that incorporate the outcome variable and thus can be more accurate.
