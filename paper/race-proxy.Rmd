...
Formally, \citet{chen2019fairness} shows that the asymptotic bias of this weighting estimator is controlled by the residual correlation of $Y$ and $R$ after controlling for $G$, $X$, and $S$.
...
This type of exclusion restriction is difficult to satisfy in many practical settings because race may affect so many factors, biasing the weighting estimator.
...
So long as we observe all information used by the manager, the weighting estimator would give an asymptotically unbiased estimate.
...
To reduce this potential bias of the weighting estimator, we propose an alternative identification assumption that may be applicable when Assumption \ref{a:indep-yr} is not credible.
...
**KI: I think we should remove dotted arrows from the figure. I realized that they violate the BISG assumption.**
