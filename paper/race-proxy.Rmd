...
Indeed, the most common techniques for estimating racial disparities using BISG probabilities are known to be biased when prediction errors are correlated with the outcome variable [@chen2019fairness].
These approaches include the use of BISG probabilities as weights and BISG classification.
