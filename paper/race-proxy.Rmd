...
As formally presented in Section \@ref(sec:id), the standard methodology of racial disparity estimation based on BISG predictions also requires individual's race to be conditionally independent of the outcome given their residence location, surnames, and other observable attributes.
...
To address this challenge, we propose an alternative identification strategy.
