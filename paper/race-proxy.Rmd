...
**KI: Two things that need to be done here.  First, it is unclear how marginalization needs to incorporate the prior, which has $R$.  Second, we should include some experiments you mention here.** 
