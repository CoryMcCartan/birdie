...
The array stored in `fit$p_xr` contains the actual estimates of the distribution of our outome given race.
...
xr = list(
    true = p_xr,
    bisg = calc_joint_bisgz(r_probs, pseudo_vf$turnout),
...
The `raceproxy` methodology meaningfully improves on the BISG estimate.
